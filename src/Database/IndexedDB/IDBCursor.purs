...
advance
    ...
    -> Aff (idb :: IDB | e) Unit
advance c i =
  fromEffFnAff $ Fn.runFn2 _advance c i
...
update
    ...
    -> Aff (idb :: IDB | e) Key
update c =
  toForeign >>> Fn.runFn2 _update c >>> fromEffFnAff >>> map toKey
...
primaryKey
  ...
  -> Aff (idb :: IDB | e) Key
primaryKey =
  _primaryKey >>> fromEffFnAff >>> map toKey
